  ...
  return (
    <ul className='socials'>
      <li className='socials__item'>
        <a
          href='https://www.linkedin.com/in/adityakankanala/'
          target='_blank'
          rel='noopener noreferrer'
          className='socials__item__link'
          title='Linkedin'>
          <svg
            className='svg-inline--fa fa-linkedin-f fa-w-14'
            aria-hidden='true'
            data-prefix='fab'
            data-icon='linkedin'
            role='img'
      ...
      <li className='socials__item'>
        <a
          ...
          title='CodeSandbox'>
          <svg
            className='svg-inline--fa fa-codesandbox fa-w-16'
            aria-hidden='true'
            data-prefix='fab'
      ...
      <li className='socials__item'>
        <a
          href='https://twitter.com/AdityaKankanala'
          target='_blank'
          rel='noopener noreferrer'
          className='socials__item__link'
          title='Twitter'>
          <svg
            className='svg-inline--fa fa-twitter fa-w-10'
            aria-hidden='true'
            data-prefix='fab'
            data-icon='twitter'
            role='img'
